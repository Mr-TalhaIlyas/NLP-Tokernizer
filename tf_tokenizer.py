# -*- coding: utf-8 -*-
"""
Created on Mon Jul 18 08:48:57 2022
...
# just split the input output pair to seprate generators.
# as the generator has baths of X-input and Y-output so here you just map them 
...
# here only the tokens against each word will be printed not reserved tokens will be present
